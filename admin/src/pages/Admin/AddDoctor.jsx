...
const AddDoctor = () => {
    ...
    return (
        <form onSubmit={onSubmitHandler} className='m-5 w-full'>
            ...
            <div className='bg-white px-8 py-8 rounded w-full max-w-4xl max-h-[80vh] overflow-scroll'>
                ...
                <div className='flex-1 flex flex-col gap-1'>
                    ...
                    <textarea onChange={(e)=> setAbout(e.target.value)} value={about}  className='w-full px-4 pt-2 border rounded' name="" id="" placeholder='Write About Doctor ' rows={5}></textarea>
                </div>
